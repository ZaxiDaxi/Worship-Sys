...
import AxiosInstance from "@/components/axios/axios"; // Preconfigured Axios instance (baseURL/interceptors)
import { Sidebar } from "@/components/Layout/Sidebar"; // App layout: left sidebar
...
import { Header } from "@/components/Layout/Header"; // App layout: top header
...
import SearchBar from "../reuse/SearchBar"; // Controlled search input + submit form
